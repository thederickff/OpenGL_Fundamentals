...
${OBJECTDIR}/IndexBuffer.o: IndexBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IndexBuffer.o IndexBuffer.cpp
...
${OBJECTDIR}/VertexArray.o: VertexArray.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VertexArray.o VertexArray.cpp

${OBJECTDIR}/VertexBuffer.o: VertexBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VertexBuffer.o VertexBuffer.cpp
